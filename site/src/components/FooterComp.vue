<template>
    <footer class="footer center">
        <div class="footer__left">
          ...
          <a href="index.html"><h3 class="footer__left__logo"> <svg width="35" height="34" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer__middle">
          <div class="footer__middle__title">Pages</div>
          <a href="#"><div class="footer__middle__text">Home</div></a>
          <a href="#"><div class="footer__middle__text">Project</div></a>
          <a href="#"><div class="footer__middle__text">Blog</div></a>

        </div>
        <div class="footer__right">
          <div class="footer__right__title">Conact</div>
          <div class="footer__right__text">55 East Birchwood Ave. Brooklyn, New York 11201  </div>
          <div class="footer__right__text">contact@interno.com</div>
          <div class="footer__right__text">(123) 456 - 7890</div>
        </div>
