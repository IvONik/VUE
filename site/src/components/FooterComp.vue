<template>
  <footer class="footer center">
    <div class="footer__part">
      ...
      <p class="footer__part__text">
        It is a long established fact that a reader will be distracted lookings.
      </p>
      <div class="footer__part__icons">
    ...
    <div class="footer__part">
      <div class="footer__part__title">Pages</div>
      <router-link to="/">
        <div class="footer__part__text">Home</div>
      </router-link>
      <router-link to="/project"><div class="footer__part__text">Project</div></router-link>
      <router-link to="/blog"><div class="footer__part__text">Blog</div></router-link>
      
    </div>
    <div class="footer__part">
      <div class="footer__part__title">Contact</div>
      <div class="footer__part__text">
        55 East Birchwood Ave. Brooklyn, New York 11201
      </div>
      <div class="footer__part__text">contact@interno.com</div>
      <div class="footer__part__text">(123) 456 - 7890</div>
    </div>
  </footer>
</template>
